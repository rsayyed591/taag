    ...
    <div className="page-container">
      <div className="content-container">
        ...
        <div className="pt-6 md:pt-12">
          ...
          <p className="text-[15px] font-manrope leading-[20.49px] font-medium text-[#979797] md:mt-6 md:text-center">
        ...
        <div className="flex-1 flex flex-col items-center justify-center mt-8 mb-16 md:my-12">
          ...
          <div className="w-full max-w-sm space-y-4 md:max-w-md">
            <label className="text-[12px] leading-[16.39px] font-manrope font-medium text-[#12766A] md:text-sm">Mobile Number</label>
