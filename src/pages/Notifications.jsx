  ...
  return (
    <div className="page-container">
      <div className="content-container pt-6 md:pt-12">
        {/* Heading */}
        <h2 className="text-2xl leading-[32.78px] font-manrope font-medium md:text-center">
            ...
            {showNotification && (
              ...
              >
                <div className="p-6 text-center">
                  <p className="text-[15px] font-manrope font-semibold leading-[20.49px] md:text-lg md:leading-relaxed">
                ...
                <div className="flex border-t border-gray-300">
                  ...
                  <button
                    className="flex-1 py-4 text-[15px] font-manrope leading-[20.49px] text-[#A3A3A3] font-medium md:text-lg md:py-5"
